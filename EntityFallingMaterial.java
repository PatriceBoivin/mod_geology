...
public class EntityFallingMaterial extends EntityFallingSand {
    public int blockID;
    public int metadata;
    ...
    public EntityFallingMaterial(World par1World)
    {
        super(par1World);
        this.fallTime = 0;
    ...
    public EntityFallingMaterial(World par1World, double par2, double par4, double par6, int par8)
    {
        this(par1World, par2, par4, par6, par8, 0);
    }

    public EntityFallingMaterial(World par1World, double par2, double par4, double par6, int par8, int par9)
    {
                ...
                if (this.onGround)
                {
                    ...
                    if (this.worldObj.getBlockId(i, j, k) != Block.pistonMoving.blockID)
                    {
                        ...
                        if (!this.isBreakingAnvil && this.worldObj.canPlaceEntityOnSide(this.blockID, i, j, k, true, 1, (Entity)null, (ItemStack)null) && !BlockSand.canFallBelow(this.worldObj, i, j - 1, k) && this.worldObj.setBlock(i, j, k, this.blockID, this.metadata, 3))
                        {
                            ...
                            {
                        		/* System.out.println("*-*-*-*-*-*-*-*-  in EntityFallingMaterial.onUpdate and the falling block has a tile entity"); */
