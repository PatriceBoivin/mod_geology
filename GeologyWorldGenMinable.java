...
public class GeologyWorldGenMinable extends WorldGenMinable
{
    ...
    public GeologyWorldGenMinable(int par1, int par2)
    {
        this(par1, par2, Block.stone.blockID);
    }

    public GeologyWorldGenMinable(int par1, int par2, int par3)
    {
    ...
    public GeologyWorldGenMinable(int id, int meta, int number, int target)
    {
                    ...
                    for (int l2 = j1; l2 <= i2; ++l2)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int i3 = k1; i3 <= j2; ++i3)
                            {
                                ...
                                {
                                	/* Patrice added the following line to avoid problems with replacing dirt and gravel */
                                	/* if (par1World.getBlockMaterial(k2, l2, i3).isSolid()) {par1World.setBlockToAir(k2, l2, i3);} */
                                    par1World.setBlock(k2, l2, i3, this.minableBlockId, minableBlockMeta, 2);
                        			/*System.out.println("replacing a stone block with a new block, with id: " + this.minableBlockId + " sub block " + minableBlockMeta);*/
